...
cols_incounting
write.csv(cols_incounting, "\\cols_incounting_061223.csv", row.names=FALSE)

unique(counting$COLUMN_D) %>% as.matrix(Column, ncol=6) -> CD_incounting
CD_incounting
write.csv(CD_incounting, "\\CD_incounting_061223.csv", row.names=FALSE)


unique(counting$C_D_R) %>% as.matrix(Column, ncol=6) -> CDR_incounting
CDR_incounting
write.csv(CDR_incounting, "\\CDR_incounting_061223.csv", row.names=FALSE)

unique(counting$C_D_R_IS) %>% as.matrix(Column, ncol=6) -> CDRIS_incounting
CDRIS_incounting
write.csv(CDRIS_incounting, "\\CDRIS_incounting_061223.csv", row.names=FALSE)
